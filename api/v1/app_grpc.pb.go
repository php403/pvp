...
type AppClient interface {
	RegisterApp(ctx context.Context, in *RegisterAppRequest, opts ...grpc.CallOption) (*RegisterAppReply, error)
	...
	LoginApp(ctx context.Context, in *LoginAppRequest, opts ...grpc.CallOption) (*LoginAppReply, error)
...
func (c *appClient) RegisterApp(ctx context.Context, in *RegisterAppRequest, opts ...grpc.CallOption) (*RegisterAppReply, error) {
	out := new(RegisterAppReply)
	err := c.cc.Invoke(ctx, "/api.v1.App/RegisterApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appClient) UpdateApp(ctx context.Context, in *UpdateAppRequest, opts ...grpc.CallOption) (*UpdateAppReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.v1.App/UpdateApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appClient) DeleteApp(ctx context.Context, in *DeleteAppRequest, opts ...grpc.CallOption) (*DeleteAppReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.v1.App/DeleteApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appClient) GetApp(ctx context.Context, in *GetAppRequest, opts ...grpc.CallOption) (*GetAppReply, error) {
	out := new(GetAppReply)
	err := c.cc.Invoke(ctx, "/api.v1.App/GetApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appClient) LoginApp(ctx context.Context, in *LoginAppRequest, opts ...grpc.CallOption) (*LoginAppReply, error) {
	out := new(LoginAppReply)
	err := c.cc.Invoke(ctx, "/api.v1.App/LoginApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appClient) ListApp(ctx context.Context, in *ListAppRequest, opts ...grpc.CallOption) (*ListAppReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.v1.App/ListApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAppServer) RegisterApp(context.Context, *RegisterAppRequest) (*RegisterAppReply, error) {
...
func (UnimplementedAppServer) LoginApp(context.Context, *LoginAppRequest) (*LoginAppReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoginApp not implemented")
}
...
func _App_RegisterApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.App/RegisterApp",
	}
...
func _App_UpdateApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.App/UpdateApp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _App_DeleteApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.App/DeleteApp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _App_LoginApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginAppRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppServer).LoginApp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.App/LoginApp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServer).LoginApp(ctx, req.(*LoginAppRequest))
	}
	return interceptor(ctx, in, info, handler)
}
